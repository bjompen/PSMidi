...
task Unit_Tests {
    # .$PSScriptRoot\Tests\TestRunner.ps1 -ModuleLoadPath "$PSScriptRoot\Source\PSMidi.psm1" -Verbosity Normal -CodeCoveragePath "$PSScriptRoot\Source\Public" 
}

task Unit_Tests_Compiled {
    # .$PSScriptRoot\Tests\TestRunner.ps1 -ModuleLoadPath "$OutputPath\PSMidi.psm1" -Verbosity Normal -CodeCoveragePath "$OutputPath\PSMidi.psm1"
}
...
task Compile_Module {
    ...
    #TODO: Enable if we create private functions.
    # Private functions
